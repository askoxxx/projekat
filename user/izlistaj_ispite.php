...
<body>
	...
	<div class="content">
		...
		<div class="user_commands">
			<form method="POST">
				<ul>
					<li id="getAllPrijave" name="getAllPrijave_btn"><a href="#">Izlistaj prijavljenje ispite</a></li>
	...
	<div id="database_content">
		<form method="POST">
			...
			<input type="text" id="filter_table" onkeyup="filterTable()" placeholder="Naziv ispita...">
		</form>
	</div>
	<footer></footer>
</body>
