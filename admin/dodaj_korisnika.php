...
<div class="user_commands">
    ...
    <form method="POST" id="dodaj_korisnika" name="adminRegisterUser" onSubmit="return validateRegisterUserAdmin()">
	...
	<div class="input-group">
		...
		<div class="input-group">
			<button type="submit" class="btn" name="create_btn">Dodaj korisnika</button>
		</div>
	</form>
	...
	<div id="database_content">
		...
		<?php getUsers(); ?>
			<input type="text" id="filter_table" onkeyup="filterTable()" placeholder="Prezime korisnika...">
		</form>
	</div>
	<footer></footer>
</body>
