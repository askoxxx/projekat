...
<body>
	...
	<div class="content">
		...
		<div class="user_commands">
			...
			<ul>
				...
				<li id="get_all_user_prijave" name="get_all_user_prijave_btn"><a href="#">Izlistaj sve prijave ispita</a></li>
				</ul>
			</form>
		</div>
	...
	<div id="database_content">
		...
		<?php getUsers(); ?>
			<input type="text" name="user_to_delete" id="filter_table" onkeyup="filterTable()" placeholder="Username korisnika...">
			<button id="delete_user_btn" name="delete_user_btn">Izbrisi korisnika</button>
		</form>
	</div>
	<footer></footer>
</body>
