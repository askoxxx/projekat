...
<body>
	...
	<div class="content">
		...
		<div class="user_commands">
			...
			<ul>
                    ...
                    <li id="activate_user" name="activate_user_btn"><a href="#">Aktiviraj Korisnika</a></li>
					<li id="get_all_user_prijave" name="get_all_user_prijave_btn"><a href="izlistaj_sve_prijave.php">Izlistaj sve prijave ispita</a></li>
				</ul>
			</form>
		</div>
	...
	<div id="database_content">
		<form method="POST">
		<h1>Nekativni korisnici</h1>
		<?php getInactiveUsers(); ?>
			<input type="text" id="filter_table" onkeyup="filterTable()" placeholder="Korisničko ime..." name="username">
			<button id="activate_user_btn" name="activate_user_btn">Aktiviraj korisnika</button>
		</form>
	</div>
	<footer></footer>
</body>
...
<script>
	...
	table = document.getElementById("all_ispiti_table");
